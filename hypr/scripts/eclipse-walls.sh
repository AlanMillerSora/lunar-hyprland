...
#
#  Видео: ~/Pictures/EclipseWalls/eclipse_01..08.webm
#    → eclipse-live-gen.py                (вид 1-в-1 с сайтом, нужен chromium)
#    → eclipse-anim-gen.py --fps 60 --no-gif --video   (SVG-порт exportPhaseSVG)
#  GIF: eclipse-anim-gen.py без --no-gif.
#
